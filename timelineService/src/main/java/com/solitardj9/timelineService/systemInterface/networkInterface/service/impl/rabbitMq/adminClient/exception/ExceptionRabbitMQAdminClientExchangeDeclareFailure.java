...
public class ExceptionRabbitMQAdminClientExchangeDeclareFailure extends Exception{
    //
	private static final long serialVersionUID = 7594371506466712673L;
	
	private final int ERR_CODE;
	
	public ExceptionRabbitMQAdminClientExchangeDeclareFailure() {
		//
	...
	public ExceptionRabbitMQAdminClientExchangeDeclareFailure(Throwable cause) {
		//
