...
public class ExceptionRabbitMQAdminClientQueueDeleteFailure extends Exception{
    //
	private static final long serialVersionUID = 7594371506466712673L;
	
	private final int ERR_CODE;
	
	public ExceptionRabbitMQAdminClientQueueDeleteFailure() {
		//
	...
	public ExceptionRabbitMQAdminClientQueueDeleteFailure(Throwable cause) {
		//
